...
public class ZombieTankTable
{
    ...
    public class BaseLayerTable
    {
        ...
        public readonly AnimationState LoopShout = new AnimationState("Base Layer.LoopShout","Base Layer");
        public readonly AnimationState LoopDrumming = new AnimationState("Base Layer.LoopDrumming","Base Layer");
